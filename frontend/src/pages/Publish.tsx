    ...
    return <div>
        ...
        <div className="flex justify-center w-full pt-8"> 
            <div className="max-w-screen-lg w-full">
                ...
                }} type="submit" className="mt-4 inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full   me-2 mb-2">
                    Publish post
                </button>
